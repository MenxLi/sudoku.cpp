...
def generate(n_clues: int, max_retries: int = 1024, parallel_exec = False, verbose = True)->list[list[int]]:
    return sudoku.generate(n_clues, max_retries, parallel_exec, verbose)
