...
SolverV1::SolverV1(const Board& board) : Solver(board) {
    ...
    USE_GUESS = parser::parse_env_i<bool>("SOLVER_USE_GUESS", true);
    DETERMINISTIC_GUESS = parser::parse_env_i("SOLVER_DETERMINISTIC_GUESS", false);
    HEURISTIC_GUESS = parser::parse_env_i("SOLVER_HEURISTIC_GUESS", true);
